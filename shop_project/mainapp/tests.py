...
#         image = SimpleUploadedFile('dart_blog.jpg', content=b'', content_type='image/jpg')
...
#         )
#         self.customer = Customer.objects.create(user=self.user, phone='1111111111', address='St')
